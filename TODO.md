...
- [WIP] @bridge-2026-07-22-swap Test: a custom subclass setting `swap_factory` gets its own swaps through `Diagram.swap`, `Hypergraph.to_diagram` and `Diagram.from_callable` (README cooking example)
