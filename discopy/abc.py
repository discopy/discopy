...
class TracedCategory[C0, C1](FeedbackCategory[C0, C1]):
    ...
    def trace(self, n: int = 1, left: bool = False) -> C1:
        """
        The trace of a morphism, generated by ``trace_factory``, which the
        implementing category provides: a :class:`monoidal.Trace` bubble for
        the free carriers, the composition with cups and caps for
        :class:`PivotalCategory`.
