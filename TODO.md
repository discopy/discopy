...
- [WIP] @session_01RPJDHX3HZeqn2EP6wQQAtB-2026-07-26 21:45 Split `markov` into `markov` (comonoid: copy, discard) and `comarkov` (monoid: merge, unit)
- [WIP] @session_01RPJDHX3HZeqn2EP6wQQAtB-2026-07-26 21:45 Add `finset.Function` and a `markov.Function` box holding the opposite of a function between finite sets
- [WIP] @session_01RPJDHX3HZeqn2EP6wQQAtB-2026-07-26 21:45 Make `markov.Layer` alternate between function-opposites and generators, the same way `symmetric.Layer` alternates permutations and generators
