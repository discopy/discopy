...
- [x] remove rule 4 per USER: “now that bots can talk to each other it makes no sense
  anymore”
- [x] nitpicks don't start a fresh `TODO.md`, per USER: “I agree with
  nitpicks not needing the TODO”
