...
- [WIP] @claude-r6h92m-2026-08-18 13:00 No regenerated drawing baselines:
  a `Swap` stays a generator rather than plumbing — no coalescing into wider
  permutations on whiskering, `from_box` keeps the swap drawing — and every
  `docs/_static` and `test/drawing/tikz` baseline reverts to `main`.
