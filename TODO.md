...
Context: this branch lands the python.additive carrier, stage of a 12-branch
...
from `daydream6728/discopy:split/4-python-additive` onto `discopy/discopy` as
a ready-for-review pull request stacked on `split/3-cmap-hypergraph-strategy`.
