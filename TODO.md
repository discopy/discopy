...
Context: this branch lands the python.multiplicative carrier, stage of a
12-branch split of daydream6728/discopy#2 ("The great purification: property
matrix over every carrier"), publishing pre-built, already-reviewed-and-tested
work from `daydream6728/discopy:split/4-python-multiplicative` onto
`discopy/discopy` as a ready-for-review pull request stacked on
`split/3-cmap-hypergraph-strategy`.
...
- [x] Open PR stacked on split/3-cmap-hypergraph-strategy using the repo's Why/What/How template
