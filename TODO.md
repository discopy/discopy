...
- [WIP] @session_01Ux5oPZt3xhLRBUZBAZTQ4f-2026-09-09 12:20 Replace the monkey-patching in the `feedback` module note by the now built-in methods, and declare `stream.Stream` the `FeedbackCategory` it already implements.
