...
- [x] @composer-2026-07-24 13:25 Fix Typst labels: Alice→unknown variable (bare words must not be math); long $math$ overflows box (canvas length 1cm vs text_width inches)
