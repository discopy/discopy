...
- [x] Ask USER about the first example, which this does not change
...
it after: it is not affected. Asked on the PR whether the complaint there is the
width of the box, which is a separate layout question.
