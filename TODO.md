...
- [ ] Make drawing backgrounds transparent, boxes white by default, and black wires visible on light and dark backgrounds.
- [ ] Add focused tests and regenerate affected documentation images.
