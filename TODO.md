...
Context: this branch lands the grammar carrier, stage of a 12-branch split of
...
`daydream6728/discopy:split/4-grammar` onto `discopy/discopy` as a
ready-for-review pull request stacked on `split/3-cmap-hypergraph-strategy`.
