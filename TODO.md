...
Context: this branch lands the cmap/hypergraph search strategy, stage of a
...
work from `daydream6728/discopy:split/3-cmap-hypergraph-strategy` onto
`discopy/discopy` as a ready-for-review pull request stacked on
`split/2-monoidal-strategy`.
...
- [x] Open PR stacked on split/2-monoidal-strategy using the repo's Why/What/How template
