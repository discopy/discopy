...
> i just merged 645, close the 3 previous PRs and open a fresh one when you're
> done

- [x] Start afresh from `main` now that it carries #645, rather than merging a
      branch whose ten commits it squashed into one
