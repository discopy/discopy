...
Context: this branch lands the hopf carrier, stage of a 12-branch split of
...
`daydream6728/discopy:split/4-hopf` onto `discopy/discopy` as a
ready-for-review pull request stacked on `split/4-tensor` (Intertwiner
subclasses tensor.Diagram and needs HypergraphCategory's axioms from stage 3,
so it structurally can't exist earlier than tensor).
