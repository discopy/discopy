...
- [x] revert `BalancedCategory(BraidedCategory, TracedCategory)`; make
...
- [x] keep only `FongEtAl19` in the bib, drop `Gavranovic24` and
  `CapucciEtAl22`, trim the docstring citation
- [x] drop the `not hasattr(Symmetric, "trace")` assert and the doctest-
