...
Context: this branch lands the quantum ZX carrier, stage of a 12-branch split
of daydream6728/discopy#2 ("The great purification: property matrix over
every carrier"), publishing pre-built, already-reviewed-and-tested work from
`daydream6728/discopy:split/4-quantum-zx` onto `discopy/discopy` as a
ready-for-review pull request stacked on `split/4-tensor` (quantum.zx.Diagram
