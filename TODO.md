...
- [WIP] @composer-2026-07-24 13:15 Fix Typst CeTZ output: A4 page shrinks diagram; boxes have stroke:none — match real string-diagram look (wires + bordered boxes, tight SVG)
