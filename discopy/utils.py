...
def factory(cls):
    ...
    remain within the subclass, by setting ``cls.factory = cls``, and gives
    it its own generators, see :class:`Generator`.
    ...
    :code:`Circuit`, built by :attr:`Arrow.generator_factory`.
